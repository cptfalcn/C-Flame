...
{
public:
    Epi2_KIOPS(CVRhsFn f, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    Epi2_KIOPS(CVRhsFn f, CVSpilsJacTimesVecFn jtv, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    Epi2_KIOPS(CVRhsFn f, EPICNumJacDelta delta, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    ~Epi2_KIOPS();
...
private:
    ...
    Epi2_KIOPS(const Epi2_KIOPS &);  // no implementation
    Epi2_KIOPS & operator=(const Epi2_KIOPS &);  // no implementation
};
