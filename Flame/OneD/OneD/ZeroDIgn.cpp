...
int main(int argc, char* argv[])
{
	...
	{//begin local scope
		...
		//We have the number of equations and grid points.
		...
		//==============
                void * cvode_mem;
		int nnz= number_of_equations*number_of_equations;
		SUNMatrix A = SUNDenseMatrix(number_of_equations, number_of_equations);
		//SUNMatrix B = SUNSparseMatrix(number_of_equations, number_of_equations,nnz, CSC_MAT);
