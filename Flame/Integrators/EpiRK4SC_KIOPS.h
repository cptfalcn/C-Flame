...
namespace EpiRK4SC_KIOPSNamespace
{
...
class EpiRK4SC_KIOPS
{
public:
    EpiRK4SC_KIOPS(CVRhsFn f, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    EpiRK4SC_KIOPS(CVRhsFn f, CVSpilsJacTimesVecFn jtv, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    EpiRK4SC_KIOPS(CVRhsFn f, EPICNumJacDelta delta, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    ~EpiRK4SC_KIOPS();
...
private:
    ...
    EpiRK4SC_KIOPS(const EpiRK4SC_KIOPS &);  // no implementation
    EpiRK4SC_KIOPS & operator=(const EpiRK4SC_KIOPS &);  // no implementation
};
