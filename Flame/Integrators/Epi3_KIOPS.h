...
{
public:
    Epi3_KIOPS(CVRhsFn f, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    Epi3_KIOPS(CVRhsFn f, CVSpilsJacTimesVecFn jtv, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    ~Epi3_KIOPS();
...
private:
    ...
    Epi3_KIOPS(const Epi3_KIOPS &);  // no implementation
    Epi3_KIOPS & operator=(const Epi3_KIOPS &);  // no implementation
};
