...
{
	//std :: cout <<"Starting to set Transport gradient\n";
	//realtype * uData    	= NV_DATA_S(State);//Stuff comes from here.
	...
	//std :: cout << "Setup complete for gradient\n";
...
// }
//=====================================================
//This is run in OneDIgnConsFinal.cpp
//=====================================================
