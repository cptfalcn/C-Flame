...
./ZeroDIgnVar.x --chemfile=$Mech/"chem.inp" --thermfile=$Mech/"therm.dat" --StepSize=1e-8 --FinalTime=$TF --MyFile=$Out --KrylovTol=1e-5 --UseJac=1 --SampleNum=1 --Method=$Method --Profiling=1 --Experiment=6 --maxSS=1e-3 --absTol=1e-12 --relTol=1e-6 --Movie=0

mv ./$Out ./SampleOutput/


Out="ZeroDVariableNHeptaneCvodeV2.txt"
Method="CVODEKry"
# #NHeptane
